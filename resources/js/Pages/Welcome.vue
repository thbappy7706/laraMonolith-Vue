                ...
                <div class="relative flex flex-col md:flex-row">
                    <a href="#_"
                       class="flex items-center mb-5 font-medium text-gray-900 lg:w-auto lg:items-center lg:justify-center md:mb-0">
                        <span class="mx-auto text-xl font-black leading-none text-gray-900 select-none">Mission AI<span
                    ...
                    <nav
                        ...
                        <a href="#_" class="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900" :class="{'font-bold underline': $page.component =='Welcome'}">Home</a>
...
<!--                        <Link :href="route('hello')" class="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">Greeting</Link>-->
                        ...
                        <NavLink :href="route('hello')" :active="$page.component =='Welcome'"> Greeting</NavLink>
...
<!--                        <Link :href="route('test.log')" method="post" as="button" :data="{foo:'bar'}" class="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">Test Log</Link>-->
                ...
                <div v-if="canLogin" class="inline-flex items-center ml-5 space-x-6 lg:justify-end">

                    <Link v-if="$page.props.auth.user"
                       :href="route('dashboard')"
                       class="text-base font-medium leading-6 text-gray-600 whitespace-no-wrap transition duration-150 ease-in-out hover:text-gray-900">Sign
                        in</Link>

                    <div v-else class="inline-flex items-center ml-5 space-x-6 lg:justify-end">
                        <Link :href="route('login')" class="text-base font-medium leading-6 text-gray-600 whitespace-no-wrap transition duration-150 ease-in-out hover:text-gray-900">Sign in</Link>
                        <Link v-if="canRegister" :href="route('register')" class="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">Sign UP</Link></div>
                </div>
                ...
                <div class="flex flex-wrap items-center sm:-mx-3">
                    <div class="w-full md:w-1/2 md:px-3">
                        <div
                            ...
                            <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">It's never
                ...
                <div class="flex flex-wrap items-center -mx-3">
                    <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                        <div class="w-full lg:max-w-md">
                            ...
                            <p class="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">It's never been easier to
        ...
        <section class="bg-white">
            <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                ...
                <p class="mt-8 text-base leading-6 text-center text-gray-400">
                    © 2021 Mission AI, Inc. All rights reserved.
                </p>
            </div>
        </section>
    </div>
